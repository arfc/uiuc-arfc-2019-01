...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
    ...
    \HRule\\[0.2cm]
     ...
     \begin{minipage}{0.4\textwidth}
        ...
        {\begin{flushright}\huge\bfseries Identifying MSR Multiphysics 
                           Modeling Challenges \end{flushright}}
    ...
    \begin{minipage}{0.9\textwidth}
        \begin{flushright}
            ...
            Kathryn D. \textsc{Huff} % Supervisor's name
                \vspace{4mm}\\
            \textit{Idaho National Laboratory Collaborator}\\
            Piyush \textsc{Sabharwall}\
        \end{flushright}
    \end{minipage}
    ...
    {\large February 10, 2019} % Date, change the \today to a set date if you want to be precise
    \vspace{0.5cm}
...
%------------------------------------------------
    ...
    \textit{This research was performed using funding received from Battelle 
    Energy Alliance LLC, Idaho National Laboratory Standard Research Contract 
    214196.}
